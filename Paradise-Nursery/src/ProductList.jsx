...
function ProductList({ onHomeClick }) {
  ...
  // 1. Correctly access the cart items array from the Redux store.
  // Assuming your CartSlice state structure is: { items: [{...}, {...}, ...] }
  const cartItems = useSelector((state) => state.cart.items);

  // 2. Calculate the total quantity dynamically based on the 'quantity' property of each item.
  // This value will update every time the cartItems array changes.
          ...
          <div>
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className="cart">
                ...
                {/* 3. Display the calculated totalQuantity */}
                {totalQuantity > 0 && (
